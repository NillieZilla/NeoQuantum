...
/**
 * This event is used to collect UUIDs of attribute modifiers that will not be displayed in items tooltips.
 * <p>
...
public class GatherSkippedAttributeTooltipsEvent extends PlayerEvent {
    ...
    /**
     * Use to determine if the advanced information on items tooltips is being shown, toggled by F3+H.
     */
