...
import static com.pixelmoncreate.neoquantum.config.Property.Type.*;
...
public class Configuration {
    ...
    public Configuration(File file) {
        ...
        try {
            ...
            Const.LOGGER.error("An exception occurred while loading config file {}. This file will be renamed to {} " + "and a new config file will be generated.", file.getName(), fileBak.getName(), e);
    ...
    public void save() {
        ...
        try {
            ...
            if (this.file.canWrite()) {
                ...
                buffer.write("# File Specification: ");
                buffer.newLine();
                buffer.newLine();
